...
어떤 분야에서 개발을 할지, 진학을 할지 취업을 할지 고민 중입니다.  
아직까지도 여러 분야를 탐구하는 중이며 특히 딥러닝과 웹개발에 관심이 많습니다.  
올해 딥러닝을 활용한 웹서비스를 배포하는 것이 목표입니다.

`Deep Learning` `Computer Vision` `Web Development`
