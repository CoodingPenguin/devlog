...
PROGRAMMERS Level1 - [최대공약수와 최소공배수](https://programmers.co.kr/learn/courses/30/lessons/12940)
...
`방법 1`은 내가 한 풀이로 유클리드 알고리즘을 그대로 구현한 것이다. 이산수학 책이나 정수론 기초 책을 본다면 금방 이해할 수 있다! `방법 2`는 다른 사람의 풀이인데 *lambda* 식으로 간단히 구현되어 있어서 정리해봤다.
