...
갱신된 증거로 사후확률을 다시 계산하면 다음과 같다. 정밀도가 첫 번째 검상 비해 많이 높아진 것을 볼 수 있다. 참고로 한 번 더 검사를 받으면 정밀도가 $99.1%$까지 올라간다.
