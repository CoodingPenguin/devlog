...
<p class="content__title">CNN은 Convolution 연산이 아니다!?</p>
<p class="content__content">CNN 연산은 위의 Convolution 수식에서 -가 아닌 +인 Cross Correlation 연산이다. 엄밀히 말하면 그런데 CNN에서는 크게 차이를 두지 않는다.</p>
</div>
</div>
