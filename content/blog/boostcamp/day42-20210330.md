...
성별/나이대 구분하는 task를
3가지에 대한
구조상으로는 되는데 attention을 이미지 classification을 넣는 게 좋은 방법일까?
https://arxiv.org/pdf/2010.11929.pdf

attention은 서로의 연관성을 구하는데
마스크와 성별, 성별과 나이 연관성이 있으니까
한 번 시도는 해보자
...
- 새벽에 돌릴 수 있도록 checkpoint 저장할 수 있는 코드 구현하기
