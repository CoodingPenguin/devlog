...
<p class="content__title">i.i.d. (independent and identically distributed)</p>
<p class="content__content">확률변수가 여러 개 있을 때 각 변수들이 서로 상호독립적이며 모두 동일한 확률분포를 가질 때를 말한다.</p>
</div>
</div>
