...
_= 커널 행의 크기 × 커널 열의 크기 × 입력의 차원 × 출력의 차원_
...
1×1 Convolution Layer는 통과하도 입력의 높이(height), 너비(width)가 줄어들지 않는다. 그럼 왜 이 Layer를 사용할까? 1×1 Convolution Layer는 다음과 같은 이유로 사용한다.
