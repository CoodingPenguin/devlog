...
<p class="content__title">왜 Fully-connected Layer가 Convolution Layer보다 더 많은 파라미터를 사용할까?</p>
<p class="content__content">Convolution의 경우 각 커널이 같은 위치에서 동일하게 적용되기 때문이다. Fully-connected Layer의 경우 모든 가중치와 입력값을 1:1 매핑하기 때문에 더 많은 파라미터가 필요하다.</p>
</div>
</div>
