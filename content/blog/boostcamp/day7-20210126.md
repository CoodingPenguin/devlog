...
<p class="content__title"><span class="katex">e_i</span>의 의미</p>
<p class="content__content">i번째 값만 1이고 나머지는 0인 단위벡터(unit vector)를 말한다. 예를 들어, <span class="katex">e_3 = [0, 0, 1, 0, 0, ...]</span>이다.</p>
</div>
</div>
