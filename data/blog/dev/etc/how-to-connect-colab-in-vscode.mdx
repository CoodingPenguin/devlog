---
title: "[ETC] VS Code에서 Colab 연결하는 방법"
date: 2022-09-12
lastmod: 2022-09-12
tags: ["vscode", "colab", "ssh"]
draft: false
summary: "까먹을까봐 적어놓는 VS Code 에디터에서 Colab 연결하는 방법"
images: ["/static/images/dev/etc/how-to-connect-colab-in-vscode/thumbnail.png"]
---
...
![](/static/images/dev/etc/how-to-connect-colab-in-vscode/google-drive-mount.png)
...
![](/static/images/dev/etc/how-to-connect-colab-in-vscode/ngrok-dashboard.png)
...
![](/static/images/dev/etc/how-to-connect-colab-in-vscode/cloudflared.png)
...
![](/static/images/dev/etc/how-to-connect-colab-in-vscode/remote-ssh-vscode-extension.png)

Visual Studio Code로 들어가 **Remote - SSH**를 설치해준다.

## Remote - SSH로 호스트랑 연결

![](/static/images/dev/etc/how-to-connect-colab-in-vscode/connect-to-host-by-ssh.png)
