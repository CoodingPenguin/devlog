---
title: "Tools | VSCode에서 Colab 연결하는 방법"
...
![](/static/images/dev/tools/how-to-connect-colab-in-vscode/google-drive-mount.png)
...
![](/static/images/dev/tools/how-to-connect-colab-in-vscode/ngrok-dashboard.png)
...
![](/static/images/dev/tools/how-to-connect-colab-in-vscode/cloudflared.png)
...
![](/static/images/dev/tools/how-to-connect-colab-in-vscode/remote-ssh-vscode-extension.png)

Visual Studio Code로 들어가 **Remote - SSH**를 설치해준다.

## Step 7. Remote - SSH로 호스트랑 연결

![](/static/images/dev/tools/how-to-connect-colab-in-vscode/connect-to-host-by-ssh.png)
