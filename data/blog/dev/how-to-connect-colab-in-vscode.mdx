...
images: ["/static/images/dev/how-to-connect-colab-in-vscode/thumbnail.png"]
---
...
![](/static/images/dev/how-to-connect-colab-in-vscode/google-drive-mount.png)
...
![](/static/images/dev/how-to-connect-colab-in-vscode/ngrok-dashboard.png)
...
![](/static/images/dev/how-to-connect-colab-in-vscode/cloudflared.png)
...
![](/static/images/dev/how-to-connect-colab-in-vscode/remote-ssh-vscode-extension.png)

Visual Studio Code로 들어가 **Remote - SSH**를 설치해준다.

## Remote - SSH로 호스트랑 연결

![](/static/images/dev/how-to-connect-colab-in-vscode/connect-to-host-by-ssh.png)
